    ...
    <div class="bg-gray-200 py-4 mb-16 ">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex">
            ...
            <div class="absolute right x-40 mt-2 bg-white border rounded shadow-xl " x-show="open" x-on:click.away="open = false">
                ...
                <a  class="cursos-pointer transition-colors duration-200 block px-4 py-2 text-normal text-gray-900 rounded hover:bg-purple-500 hover:text-white" wire:click="$set('level_id', {{$level->id}})" x-on:click="open = false">{{$level->name}} </a>
