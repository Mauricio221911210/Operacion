<section>
    <h1 class="text-2xl font-bold ">Audiencia del Archivo</h1>
    <hr class="mt-2 mb-6 ">
    ...
    <article class="card">
        <div class="card-body bg-gray-100">
            <form wire:submit.prevent="store">
                <input wire:model="name" class="form-input w-full" placeholder="Agregar nombre del tipo de Audiencia">
                ...
                <div class="flex justify-end mt-2">
                    <button type="submit" class="btn btn-success">Agregar el tipo de Audiencia</button>
                </div>
            </form>
        </div>
    </article>
