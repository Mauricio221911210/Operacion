<section>
    <h1 class="text-2xl font-bold ">Requerimientos del Archivo</h1>
    <hr class="mt-2 mb-6 ">
    ...
    <article class="card">
        <div class="card-body bg-gray-100">
            <form wire:submit.prevent="store">
                <input wire:model="name" class="form-input w-full" placeholder="Agregar nombre de un Requerimiento del Archivo">
